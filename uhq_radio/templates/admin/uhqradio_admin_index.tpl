...
<ul>
    ...
    <li>
        <{$list.test}> -
        <{if $list.result}>
        <font color=green><{$smarty.const._AM_UHQRADIO_TEST_OK}>
            <{else}>
            <font color=red><{$smarty.const._AM_UHQRADIO_TEST_NOK}>
                <{/if}>
            </font>
    </li>
    <{/foreach}>
...
<ul>
    ...
    <li><{$list.module}> -
        <{if $list.installed}>
        <font color=green><{$smarty.const._AM_UHQRADIO_MODULE_INSTALLED}></font>
        <{else}>
