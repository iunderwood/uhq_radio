...
<center>
    ...
    <{else}>
    <img src="<{$smarty.const._MB_UHQRADIO_ONAIR_NODJPIC}>" title="<{$smarty.const._MB_UHQRADIO_ONAIR_NODJPIC_TXT}>">
    <{/if}>
</center>
<hr>
<{$smarty.const._MB_UHQRADIO_ONAIR_DJHDR}><a href="/modules/uhq_radio/djprofile.php?djid=<{$block.dj.djid}>"><{$block.dj.name}></a>
