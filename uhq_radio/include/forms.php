...
if (file_exists(XOOPS_ROOT_PATH.'/modules/uhq_radio/language/'.$xoopsConfig['language'].'/form.php')) {
	include_once XOOPS_ROOT_PATH.'/modules/uhq_radio/language/'.$xoopsConfig['language'].'/form.php';
} else {
	include_once XOOPS_ROOT_PATH.'/modules/uhq_radio/language/english/form.php';
}
