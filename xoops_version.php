...
$modversion['templates'] = [
    ['file' => 'uhqradio_djprofile.tpl', 'description' => _MI_UHQRADIO_TEMPLATE_DJPROFILE],
    ['file' => 'admin/' . 'uhqradio_admin_airstaff.tpl', 'description' => _MI_UHQRADIO_TEMPLATE_ADM_AIRSTAFF],
    [
        'file'        => 'admin/' . 'uhqradio_admin_mountpoints.tpl',
        'description' => _MI_UHQRADIO_TEMPLATE_ADM_MOUNTPOINTS
    ],
    ['file' => 'admin/' . 'uhqradio_admin_channels.tpl', 'description' => _MI_UHQRADIO_TEMPLATE_ADM_CHANNELS],
    ['file' => 'uhqradio_xml_status.xml', 'description' => _MI_UHQRADIO_TEMPLATE_XML_STATUS],
    ['file' => 'uhqradio_index.tpl', 'description' => _MI_UHQRADIO_TEMPLATE_INDEX],
    ['file' => 'uhqradio_playlist.tpl', 'description' => _MI_UHQRADIO_TEMPLATE_PLAYLIST],
    ['file' => 'pop/' . 'uhqradio_pop_songinfo.tpl', 'description' => _MI_UHQRADIO_TEMPLATE_POP_SONGINFO],
    ['file' => 'pop/' . 'uhqradio_pop_djtest.tpl', 'description' => _MI_UHQRADIO_TEMPLATE_POP_DJTEST],
    ['file' => 'pop/' . 'uhqradio_pop_request.tpl', 'description' => _MI_UHQRADIO_TEMPLATE_POP_REQUEST],
    ['file' => 'uhqradio_request.tpl', 'description' => _MI_UHQRADIO_TEMPLATE_REQUEST],// NRE Working Template
    ['file' => 'uhqradio_sm_songhistory.tpl', 'description' => _MI_UHQRADIO_TEMPLATE_SM_SONGHISTORY],
    ['file' => 'uhqradio_sm_toprequests.tpl', 'description' => _MI_UHQRADIO_TEMPLATE_SM_TOPREQUESTS],
    ['file' => 'admin/' . 'uhqradio_admin_index.tpl', 'description' => _MI_UHQRADIO_TEMPLATE_ADM_INDEX]
];
