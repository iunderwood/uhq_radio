...
define("_FM_UHQRADIO_SAMDB_HDR","<h3>SAM Broadcaster Integration</h3><p>This section contains the information needed to access your MySQL database and coordiate requests w/ SAM.</p><p>The default ports are 3306 for SQL and 1221 for SAM.  Please forward a unique port number to these ports through your firewall or gateway router.</p>");
...
define("_FM_UHQRADIO_MOUNT_DELWARN","<font color=red>WARNING!</font><br><p>Deleting this mountpoint will remove it from all counter maps, playlists, and disassociate it from any channel text information.</p>");
...
define("_FM_UHQRADIO_CHANNEL_DELWARN","<font color=red>WARNING!</font><br><p>Deleting this channel will remove it from all counter maps and will delete its playlist.</p>");
