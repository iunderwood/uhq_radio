...
function b_uhqradio_status_edit($options)
{
	...
	if ($options[6] == "1") $form .= "checked='checked'";
	$form .= "/>";
	$form .= _MB_UHQRADIO_YES;
	$form .= "<input type='radio' name='options[6]' value= '0' ";
	if ($options[6] == "0") $form .= "checked='checked'";
	$form .= "/>";
	$form .= _MB_UHQRADIO_NO;
	$form .= "<br />";
	...
	if ($options[7] == "1") $form .= "checked='checked'";
	$form .= "/>";
	$form .= _MB_UHQRADIO_YES;
	$form .= "<input type='radio' name='options[7]' value= '0' ";
	if ($options[7] == "0") $form .= "checked='checked'";
	$form .= "/>";
	$form .= _MB_UHQRADIO_NO;
	$form .= "<br />";
	...
	if ($options[8] == "0") $form .= "checked='checked'";
	$form .= "/>";
	$form .= _MB_UHQRADIO_NO;
	$form .= "<br />";
	...
	if ($options[9] == "1") $form .= "checked='checked'";
	$form .= "/>";
	$form .= _MB_UHQRADIO_YES;
	$form .= "<input type='radio' name='options[9]' value= '0' ";
	if ($options[9] == "0") $form .= "checked='checked'";
	$form .= "/>";
	$form .= _MB_UHQRADIO_NO;
	$form .= "<br />";	
	...
	if ($options[10] == "1") $form .= "checked='checked'";
	$form .= "/>";
	$form .= _MB_UHQRADIO_YES;
	$form .= "<input type='radio' name='options[10]' value= '0' ";
	if ($options[10] == "0") $form .= "checked='checked'";
	$form .= "/>";
	$form .= _MB_UHQRADIO_NO;
	$form .= "<br />";
	return $form;
...
function b_uhqradio_handoff_show($options)
{
	...
	if ( $handoff['reqtime'] ) {
		if ( $xoopsUser->uid() == $handoff['requser'] ) {
			...
			$user = $member_handler->getUser($handoff['requser']);
