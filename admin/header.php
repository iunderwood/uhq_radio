...
function adminMenu($currentoption = 0, $breadcrumb = '')
{
	...
	if(file_exists(XOOPS_ROOT_PATH.'/modules/uhq_radio/language/'.$xoopsConfig['language'].'/modinfo.php')) {
		include_once XOOPS_ROOT_PATH.'/modules/uhq_radio/language/'.$xoopsConfig['language'].'/modinfo.php';
	} else {
		include_once XOOPS_ROOT_PATH.'/modules/uhq_radio/language/english/modinfo.php';
	}
